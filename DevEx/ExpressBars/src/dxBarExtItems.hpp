...
__published:
	...
	__property int LargeImageIndex = {read=FLargeImageIndex, write=SetLargeImageIndex, stored=IsLargeImageIndexStored, default=-1};
	__property bool ShowCaption = {read=FShowCaption, write=SetShowCaption, default=1};
	__property int Width = {read=FWidth, write=SetWidth, default=0};
	__property ImageIndex  = {stored=IsImageIndexStored, default=-1};
...
protected:
	...
	virtual int __fastcall GetDefaultWidth(void);
	virtual int __fastcall GetHeight(void);
	virtual bool __fastcall GetImageEnabled(Dxbar::TdxBarPaintType APaintType);
	virtual int __fastcall GetWidth(void);
	virtual void __fastcall Paint(const Types::TRect &ARect, Dxbar::TdxBarPaintType PaintType);
...
#pragma option push -b-
enum TdxBarDateOnStart { bdsToday, bdsNullDate, bdsCustom };
#pragma option pop
...
protected:
	...
	virtual void __fastcall DrawInterior(Dxbar::TdxBarEditControl* ABarEditControl, Graphics::TCanvas* ACanvas, const Types::TRect &R, Dxbar::TdxBarItemLink* ItemLink);
	DYNAMIC void __fastcall DropDown(int X, int Y);
	virtual HWND __fastcall GetDropDownWindow(void);
...
private:
	Dxbar::TdxBarSpinEditButton FActiveButton;
	bool FButtonPressed;
	#pragma pack(push, 1)
	...
	void __fastcall SetActiveButton(Dxbar::TdxBarSpinEditButton Value);
	void __fastcall SetButtonPressed(bool Value);
	
protected:
	void __fastcall BreakProcess(void);
	Dxbar::TdxBarSpinEditButton __fastcall ButtonFromPoint(const Types::TPoint &P);
	virtual void __fastcall Paint(const Types::TRect &ARect, Dxbar::TdxBarPaintType PaintType);
	virtual void __fastcall WndProc(Messages::TMessage &Message);
	__property Dxbar::TdxBarSpinEditButton ActiveButton = {read=FActiveButton, write=SetActiveButton, nodefault};
