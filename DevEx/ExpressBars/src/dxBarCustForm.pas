...
type
  ...
  protected
    class procedure DrawSubItemArrow(ACanvas: TCanvas; X, Y: Integer); virtual;
  public
...
begin
  ...
  begin
    ...
    begin
      ...
      DrawSubItemArrow(ACanvas, ARect.Right - (4 + 5), ARect.Top + (dxBarButtonHeight - 7) div 2);
    end
    else
  ...
  begin
    ...
    begin
      ...
      if Selected then
        InflateRect(R, -1, -1);
      InflateRect(R, 2, 0);
      DrawItemArrow(Handle, R, atDown, True, False, True{Flat});
    end;
  end;
end;
