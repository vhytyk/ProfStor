...
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TdxBarCustomizingFormPainter;
class PASCALIMPLEMENTATION TdxBarCustomizingFormPainter : public System::TObject 
{
	typedef System::TObject inherited;
	
protected:
	/* virtual class method */ virtual void __fastcall DrawSubItemArrow(TMetaClass* vmt, Graphics::TCanvas* ACanvas, int X, int Y);
	
public:
	/* virtual class method */ virtual Graphics::TColor __fastcall BrushColors(TMetaClass* vmt, bool Selected, Dxbar::TdxBarItem* AItem);
	/* virtual class method */ virtual void __fastcall DrawButtonOrSubItem(TMetaClass* vmt, Graphics::TCanvas* ACanvas, const Types::TRect &ARect, Dxbar::TdxBarItem* AItem, AnsiString ACaption, bool Selected);
	/* virtual class method */ virtual void __fastcall DrawEditOrCombo(TMetaClass* vmt, Graphics::TCanvas* ACanvas, const Types::TRect &ARect, Dxbar::TdxBarItem* AItem, AnsiString ACaption, bool Selected);
	/* virtual class method */ virtual void __fastcall DrawFocusedRect(TMetaClass* vmt, Graphics::TCanvas* ACanvas, const Types::TRect &ARect, Dxbar::TdxBarItem* AItem);
	/* virtual class method */ virtual Graphics::TColor __fastcall FontColors(TMetaClass* vmt, bool Selected);
public:
	#pragma option push -w-inl
	/* TObject.Create */ inline __fastcall TdxBarCustomizingFormPainter(void) : System::TObject() { }
	#pragma option pop
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TdxBarCustomizingFormPainter(void) { }
	#pragma option pop
	
};


typedef TMetaClass*TdxBarCustomizingFormPainterClass;

class DELPHICLASS TdxBarCustomizingFormStandardPainter;
class PASCALIMPLEMENTATION TdxBarCustomizingFormStandardPainter : public TdxBarCustomizingFormPainter 
{
	typedef TdxBarCustomizingFormPainter inherited;
	
public:
	/* virtual class method */ virtual void __fastcall DrawFocusedRect(TMetaClass* vmt, Graphics::TCanvas* ACanvas, const Types::TRect &ARect, Dxbar::TdxBarItem* AItem);
public:
	#pragma option push -w-inl
	/* TObject.Create */ inline __fastcall TdxBarCustomizingFormStandardPainter(void) : TdxBarCustomizingFormPainter() { }
	#pragma option pop
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TdxBarCustomizingFormStandardPainter(void) { }
	#pragma option pop
	
};


class DELPHICLASS TdxBarCustomizingFormFlatPainter;
class PASCALIMPLEMENTATION TdxBarCustomizingFormFlatPainter : public TdxBarCustomizingFormPainter 
{
	typedef TdxBarCustomizingFormPainter inherited;
...
public:
	#pragma option push -w-inl
	/* TObject.Create */ inline __fastcall TdxBarCustomizingFormFlatPainter(void) : TdxBarCustomizingFormPainter() { }
	#pragma option pop
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TdxBarCustomizingFormFlatPainter(void) { }
	#pragma option pop
	
};


class DELPHICLASS TdxBarCustomizingFormOffice11Painter;
class PASCALIMPLEMENTATION TdxBarCustomizingFormOffice11Painter : public TdxBarCustomizingFormFlatPainter 
{
	typedef TdxBarCustomizingFormFlatPainter inherited;
...
public:
	#pragma option push -w-inl
	/* TObject.Create */ inline __fastcall TdxBarCustomizingFormOffice11Painter(void) : TdxBarCustomizingFormFlatPainter() { }
	#pragma option pop
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TdxBarCustomizingFormOffice11Painter(void) { }
	#pragma option pop
	
};


class DELPHICLASS TdxBarCustomizingFormXPPainter;
class PASCALIMPLEMENTATION TdxBarCustomizingFormXPPainter : public TdxBarCustomizingFormPainter 
{
	typedef TdxBarCustomizingFormPainter inherited;
...
public:
	#pragma option push -w-inl
	/* TObject.Create */ inline __fastcall TdxBarCustomizingFormXPPainter(void) : TdxBarCustomizingFormPainter() { }
	#pragma option pop
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TdxBarCustomizingFormXPPainter(void) { }
	#pragma option pop
...
enum dxBarCustForm__7 { glbGroups, glbItems };
#pragma option pop
...
private:
	...
	dxBarCustForm__7 LastActiveGroupListBox;
...
extern PACKAGE void __fastcall DeleteCustomizingBar(Dxbar::TdxBar* ABar);
...
extern PACKAGE void __fastcall UpdateCustomizingCommands(Dxbar::TdxBarItem* AItem);
