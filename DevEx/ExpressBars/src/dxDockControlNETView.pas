...
type
  ...
  protected
    class procedure AssignDefaultFont; override;
...
uses Math, dxDockConsts;

{ TdxDockControlNETPainter }

class procedure TdxDockControlNETPainter.AssignDefaultFont;
begin
...
procedure TdxDockControlNETPainter.DrawTab(ACanvas: TCanvas;
