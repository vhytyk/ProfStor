...
uses
  ...
  cxTextEdit, cxButtonEdit, cxDropDownEdit, cxImage, cxMaskEdit, cxCalendar,
  cxCurrencyEdit, cxSpinEdit, cxMemo, cxImageComboBox, cxBlobEdit, cxCalc,
  cxCheckBox, cxTimeEdit, cxHyperLinkEdit, cxMRUEdit, cxRadioGroup;
...
type
  TcxCustomEditPropertiesAccess = class(TcxCustomEditProperties); // TODO: public
