...
function TcxEditDataRegisteredRepositoryItems.GetItem(AValueTypeClass: TcxValueTypeClass): TcxEditRepositoryItem;
begin
  Result := inherited GetItem(Integer(AValueTypeClass));
end;
...
begin
  inherited RegisterItem(Integer(AValueTypeClass), AVersion, ARepositoryItem);
end;

procedure TcxEditDataRegisteredRepositoryItems.UnregisterItem(AValueTypeClass: TcxValueTypeClass;
  AVersion: Integer);
begin
  inherited UnregisterItem(Integer(AValueTypeClass), AVersion);
end;
