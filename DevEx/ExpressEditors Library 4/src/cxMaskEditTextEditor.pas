...
type
  TcxMaskEditAccessor = class(TcxCustomMaskEdit);

procedure TcxMaskEditTextEditorDlg.FormShow(Sender: TObject);
begin
  with TcxMaskEditAccessor(MaskEdit) do
  begin
    cxMaskEdit1.Properties.AlwaysShowBlanksAndLiterals := True;
    cxMaskEdit1.Properties.MaxLength := Properties.MaxLength;
    cxMaskEdit1.Text := '';
    cxMaskEdit1.Properties.MaskKind := Properties.MaskKind;
    cxMaskEdit1.Properties.EditMask := Properties.EditMask;
    cxMaskEdit1.Properties.MaxLength := Properties.MaxLength;
    cxMaskEdit1.Properties.CaseInsensitive := Properties.CaseInsensitive;
    cxMaskEdit1.Text := Text;
    if Properties.IsMasked then
      Label3.Caption := Properties.EditMask
    else
...
begin
  TcxMaskEditAccessor(MaskEdit).Text := cxMaskEdit1.Text;
  Close;
end;
