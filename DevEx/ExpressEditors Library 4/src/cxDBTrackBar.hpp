...
// (DO NOT EDIT: machine generated header) 'cxDBTrackBar.pas' rev: 6.00
...
public:
	...
	/* TcxCustomTrackBar.Create */ inline __fastcall virtual TcxDBTrackBar(Classes::TComponent* AOwner)/* overload */ : Cxtrackbar::TcxCustomTrackBar(AOwner) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TcxCustomEdit.Destroy */ inline __fastcall virtual ~TcxDBTrackBar(void) { }
	#pragma option pop
