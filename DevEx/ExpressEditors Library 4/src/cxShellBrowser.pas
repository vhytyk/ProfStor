...
type
  ...
  private
    ...
    function GetShellOptions: TCxShellOptions;
    procedure SetShellOptions(const Value: TCxShellOptions);
  ...
  public
    ...
    property DlgOptions: TCxShellOptions read GetShellOptions write SetShellOptions;
...
begin
  cxTeFolder.Text := MinimizeName(cxStv.AbsolutePath, Canvas, cxTeFolder.Width);
...
begin
  with cxTeFolder do
    Text := MinimizeName(cxStv.AbsolutePath, Self.Canvas, Width);
  //  cxStv.InnerTreeView.Selected.MakeVisible;  
end;

procedure TcxShellBrowserDlg.SetShellOptions(const Value: TCxShellOptions);
begin
  cxStv.Options := Value;
end;
...
function TcxShellBrowserDlg.GetShellOptions: TCxShellOptions;
begin
