...
uses
  ...
  Qt, QTypes, Types,
  {$ENDIF}
  Classes, SysUtils, Graphics, Controls, StdCtrls, Forms, cxClasses, cxEdit,
  cxTextEdit, cxLabel, cxFontNameComboBox, cxColorComboBox, cxProgressBar,
  cxTrackBar, cxGroupBox, cxSpinButton, cxCheckComboBox;
...
type
  ...
  { TcxEditRepositorySpinButton }
  TcxEditRepositorySpinButton = class(TcxEditRepositoryItem)
  private
...
{ TcxEditRepositorySpinButton }
class function TcxEditRepositorySpinButton.GetEditPropertiesClass: TcxCustomEditPropertiesClass;
begin
  Result := TcxSpinButtonProperties;
end;

function TcxEditRepositorySpinButton.GetProperties: TcxSpinButtonProperties;
begin
  Result := inherited Properties as TcxSpinButtonProperties;
end;

procedure TcxEditRepositorySpinButton.SetProperties(Value: TcxSpinButtonProperties);
begin
  inherited Properties := Value;
end;
{ TcxEditRepositorySpinButton }
