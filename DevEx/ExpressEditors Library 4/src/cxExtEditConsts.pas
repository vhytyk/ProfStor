...
{$IFDEF DELPHI6}
  Variants,
{$ENDIF}
  Classes, SysUtils, Graphics, cxContainer;
...
resourcestring
  ...
  scxUDAssociated = '%s is already associated with %s';
...
type
  ...
  { TcxExtContainerStyle }
  TcxExtContainerStyle = class(TcxContainerStyle)
  public
...
const
  ...
  cxHTML4ColorValues: array[0..15] of Integer =
  ...
  cxX11ColorValues: array[0..139] of Integer =
  ...
  cxX11OrderedColorValues: array[0..139] of Integer =
...
{ TcxExtContainerStyle }
procedure TcxExtContainerStyle.RestoreDefaults;
begin
  inherited RestoreDefaults;
  if Container <> nil then
  begin
    TcxContainerAccess(Container).ParentColor := False;
    TcxContainerAccess(Container).ParentFont := True;
  end;
  BorderColor := DefaultBorderColor;
  BorderStyle := DefaultBorderStyle;
  Color := DefaultColor;
  Edges := DefaultEdges;
  HotTrack := DefaultHotTrack;
