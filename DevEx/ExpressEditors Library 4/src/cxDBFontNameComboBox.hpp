...
// (DO NOT EDIT: machine generated header) 'cxDBFontNameComboBox.pas' rev: 6.00
...
public:
	...
	/* TcxCustomFontNameComboBox.Create */ inline __fastcall virtual TcxDBFontNameComboBox(Classes::TComponent* AOwner)/* overload */ : Cxfontnamecombobox::TcxCustomFontNameComboBox(AOwner) { }
	#pragma option pop
