...
{$IFDEF DELPHI6}
  Variants,
{$ENDIF}
  cxEdit, cxDBEdit, cxFontNameComboBox;
...
{ TcxDBFontNameComboBox }
function TcxDBFontNameComboBox.GetDataBinding: TcxDBEditDataBinding;
begin
  Result := TcxDBEditDataBinding(FDataBinding);
end;

procedure TcxDBFontNameComboBox.SetDataBinding(const Value: TcxDBEditDataBinding);
begin
