...
procedure TcxGridCardViewRowStyles.GetDefaultViewParams(Index: Integer; AData: Pointer;
  out AParams: TcxViewParams);
begin
  case Index of
    isCaptionRow:
      GridView.Styles.GetCaptionRowParams(AData, Item, AParams);
    isRowCaption:
      GridView.Styles.GetRowCaptionParams(AData, Item, AParams);
  else
    inherited;
  end;
end;
...
procedure TcxGridCardViewStyles.GetDefaultViewParams(Index: Integer; AData: Pointer;
  out AParams: TcxViewParams);
begin
  case Index of
    vsCardBorder:
      GetRecordContentParams(AData, nil, AParams);
