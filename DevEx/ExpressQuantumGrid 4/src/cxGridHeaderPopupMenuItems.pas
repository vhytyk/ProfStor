...
type
  ...
  TcxGridSortColumn = class(TcxGridHeaderPopupMenuOperation)
  protected
...
uses
  ...
  cxCustomData, cxEdit, cxMaskEdit, cxGridPopUpMenuConsts;
...
procedure TcxGridSortColumn.DoSort(Sender: TObject);
var
...
begin
  Result := (esoSorting in HitColumn.GetProperties.GetSupportedOperations) and
    HitColumn.Options.Sorting and
...
begin
  SetProperties(AMenuItem, DoSort);
