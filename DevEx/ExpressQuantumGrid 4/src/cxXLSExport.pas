...
{       ExpressExport                                               }
{                                                                   }
{       Copyright (c) 2001-2002 Developer Express Inc.              }
{       ALL RIGHTS RESERVED                                         }
{                                                                   }
...
var
  ARet: Extended;
begin
   Result := TextToFloat(PChar(AString), ARet, fvExtended);
   if Result then
     Value := ARet
   else
     Value := 0;
...
function TcxXLSSharedStringTable.Add(const AString: WideString): Integer;
begin
