...
type
  ...
  TcxGridBand = class(TCollectionItem, IcxStoredObject)
  private
    FCaption: string;
    FColumns: TList;
  ...
  TcxGridBands = class(TOwnedCollection, IcxStoredObject, IcxStoredParent)
  private
...
{$IFDEF DELPHI6}
  Variants,
{$ENDIF}
  SysUtils, Math, cxGridStrs, cxGridViewData, cxCustomData;
...
var
  ALeftBound, ATopBound, ALineHeight, I: Integer;
  AColumnViewInfo: TcxGridBandedColumnHeaderViewInfo;
...
begin
  ...
  begin
    ...
    AColumnViewInfo.Calculate(ALeftBound, ATopBound, -1, GetColumnHeight);
    Inc(ALeftBound, AColumnViewInfo.Width);
  end;
end;
...
begin
  ...
  begin
    New(ACellPos);
    try
      with PcxGridDataCellPos(ACellPos)^ do
      begin
...
procedure TcxGridBandedColumnStyles.GetDefaultViewParams(Index: Integer; AData: Pointer;
...
procedure TcxGridBandStyles.GetDefaultViewParams(Index: Integer; AData: Pointer;
  out AParams: TcxViewParams);
begin
  case Index of
    bsBackground:
    ...
    bsHeader:
      GridView.Styles.GetBandHeaderParams(AData, AParams);
  else
    inherited;
  end;
end;
