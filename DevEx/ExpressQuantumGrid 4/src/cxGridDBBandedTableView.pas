...
type
  ...
  TcxGridDBBandedTableSummaryItem = class(TcxDBDataSummaryItem, IcxStoredObject)
  private
...
begin
  if AName = 'Column' then
    Column := (DataController as TcxGridDBDataController).GridView.FindItemByName(AValue) as TcxGridDBBandedColumn;
end;
