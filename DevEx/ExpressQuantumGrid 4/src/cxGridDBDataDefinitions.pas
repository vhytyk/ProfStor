...
type
  ...
  public
    ...
    function GetItemSortByDisplayText(AItemIndex: Integer): Boolean; override;
...
class function TcxGridDBDataController.GetItemID(AItem: TObject): Integer;
begin
...
function TcxGridDBDataController.GetItemSortByDisplayText(AItemIndex: Integer): Boolean;
begin
