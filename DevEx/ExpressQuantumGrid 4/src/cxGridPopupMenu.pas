...
{$ENDIF}
  ...
  cxGridTableView, cxGridUIHelper, cxGridUICustomTableHelper, cxGridUITableHelper,
...
uses
  cxGridLevel, Dialogs, cxGridStdPopupMenu, Menus;
...
begin
  ...
  for I := 0 to FGridDefaultPopupMenu.Count - 1 do
    if FGridDefaultPopupMenu[i].PopupMenu.ClassType = AMenuClass then
    begin
...
function TcxGridPopupMenu.DoPopup: Boolean;
