...
begin
  ...
  begin
    ...
    {$ELSE}
      case Application.MessageBox(GetDeleteItemsCaption, 'Confirm', [smbYes, smbNo, smbCancel], smsWarning) of
    {$ENDIF}
      {$IFDEF VCL}
        IDYES:
      {$ELSE}
...
begin
  inherited;
{$IFNDEF VCL}
  LBColumns.BeginDrag(False, Mouse.DragThreshold);
{$ENDIF}
end;
