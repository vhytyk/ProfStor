...
uses
  Classes, SysUtils, {$IFDEF DELPHI6}Variants, {$ENDIF} DB, cxDataUtils;
...
type
  ...
  public
    constructor Create(ADataSetClass: TDataSetClass);
  ...
  public
    constructor Create(ADataBinding: TcxCustomDBDataBinding);
...
procedure TcxCustomFieldDataLink.DataEvent(Event: TDataEvent; Info: Longint);
begin
