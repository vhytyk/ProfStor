...
function OpenTheme(AThemedObjectType: TdxThemedObjectType; APClassNameList: PWideChar = nil): TTheme;
...
uses
  Classes, SyncObjs, dxThemeConsts;
...
//          WideSameStr(WideUpperCase(ClassNameList), WideUpperCase(APClassNameList^)) then
      begin
        Result := Theme;
        Exit;
      end
